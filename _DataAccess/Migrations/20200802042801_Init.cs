    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardRequests", x => new { x.Id, x.BoardId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BoardRequests_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardRequests_BoardId",
                table: "BoardRequests",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardRequests_UserId",
                table: "BoardRequests",
                column: "UserId");
